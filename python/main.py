...
parser.add_argument('--connection_time',  '-ct', type=int, default=20)
parser.add_argument('--recruit_duration', '-rd', type=int, default=90)
parser.add_argument('--battle_duration',  '-bd', type=int, default=70)
parser.add_argument('--raid_password',    '-rp', type=int, default=5963)
parser.add_argument('--exit_mode',        '-em', default='flight')
# --- other setting ---
